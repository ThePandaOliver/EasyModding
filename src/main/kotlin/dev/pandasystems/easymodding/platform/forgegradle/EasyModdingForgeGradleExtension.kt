...
abstract class EasyModdingForgeGradleExtension @Inject constructor(
	...
	override val platform: PluginPlatform = PluginPlatform.MODDEV
	...
	override val modDependencies: EasyModdingDependencies = objects.newInstance(EasyModdingForgeGradleDependencies::class.java)
}