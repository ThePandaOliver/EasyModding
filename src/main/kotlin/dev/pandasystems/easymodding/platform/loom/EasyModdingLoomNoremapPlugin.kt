 ...
 *
 * Registered as `dev.pandasystems.easymodding.loom-noremap` and applied automatically by the main plugin
 * when `easy_modding.platform=loom-noremap`. It applies Loom and, once the project is fully configured,
 * declares the Minecraft dependency using the version from the shared `easyModding` extension.
 * 
 * This is the no-remap variant of Fabric Loom, suitable for Minecraft versions above 1.21.11.
 */
