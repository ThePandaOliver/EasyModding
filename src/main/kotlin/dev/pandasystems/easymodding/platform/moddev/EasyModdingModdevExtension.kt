...
abstract class EasyModdingModdevExtension @Inject constructor(
	...
	override val modDependencies: EasyModdingDependencies = objects.newInstance(EasyModdingModdevDependencies::class.java)
}